...
from dev.engine import train_classification, train_translation, eval_classification
...
if __name__ == "__main__":
    ...
    if config.MODEL_PARAMS[model_type]["type"] == "classification":
        train_classification(model, train_loader, val_loader, epochs_no, learning_rate, early_stopping = early_stopping, patience = patience, load = load_model)
    elif config.MODEL_PARAMS[model_type]["type"] == "translation":
        train_translation(model, train_loader, val_loader, epochs_no, learning_rate, early_stopping = early_stopping, patience = patience,  load = load_model)
